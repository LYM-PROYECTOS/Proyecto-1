...
public class RobotWorld {
	...
	*/
	...
	/**
	 * Start the board with some randomly allocated blocked tiles 
	 */
	...
	/**
	 * Move the robot to  specific position
	 * If the , the behavior is not defined
	 */
	...
	private void buscarErrores() {
		...
		else if  (isBlocked(this.position) )
		    comportamientoDeError("Blocked position" + (this.position));
	}
